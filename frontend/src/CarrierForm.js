...
export const CarrierForm = () => {
    ...
    return (
        <>
            ...
            <div className="form-row px-2 d-flex justify-content-between align-items-center">
            ...
            {rows.map((row, index) => (
                <div key={index} className="form-row px-2 d-flex justify-content-between align-items-center">
                    ...
                    {index == 0 ? <>
                        <div class="form-group col-md-1">
                            <button className="form-select my-submit h-100 offset-md-4" onClick={handleSubmit}>Submit</button>
                        </div>
                        <div class="form-group col-md-1">
