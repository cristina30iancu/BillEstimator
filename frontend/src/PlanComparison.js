...
export const PlanComparison = () => {
    ...
    const planComparisonData = ["Monthly Plan Lines", "Monthly Carrier Plans", "Monthly Device",
        "Total Mobile Protection/Features", "Accessories", "Monthly CreditsTrade-in Credits", "Trade-in Credits"]
    ...
    const handleSubmit = () => {
        ...
        setEditingIndex(-1);
        setRows([...rows]);
        const sumFinalCost = rows.reduce((total, row) => parseFloat(total) + (parseFloat(row.differences) || 0), 0);
                ...
                <div className="col-md-6 border-end border-dark">
                    <div className="row mb-3">
                        ...
                        <div className="col-md-3 border-end">
                            <CurrencyInput placeholder="$0.00" className='form-control' name="oldPlan" value={row['oldPlan'] || ''}
                                onValueChange={(value, name) => handleCurrencyInputChange(value, name, index)} 
                                decimalsLimit={2} prefix="$" decimalSeparator="." groupSeparator=","
                            />
                        </div>
                        <div className="col-md-3 border-end">
                            <CurrencyInput placeholder="$0.00" className='form-control mr-2' name='newPlan' value={row['newPlan'] || ''}
                                decimalsLimit={2} prefix="$" decimalSeparator="." groupSeparator="," onValueChange={(value, name) => handleCurrencyInputChange(value, name, index)} 
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-6">
                    <div className="row mb-3">
                        <div className="col-md-2">
                            <CurrencyInput placeholder="$0.00" value={row['differences'] || ''} className='form-control'
                ...
                <div className="col-md-6 border-end border-dark">
                    <div className="row">
                        <div className="col-md-6 border-end">
                            ...
                            <FontAwesomeIcon className='ml-5' onClick={() => handleEditRow(index)} icon={faEdit} />
                            <FontAwesomeIcon className='ml-2' icon={faTrashAlt} onClick={() => handleDeleteRow(index)} />
                        </div>
                        <div className="col-md-3 border-end">
                        <p>${row[`oldPlan`]}</p>
                        </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2 offset-md-6 exclude-from-print mt-3">
                            <div className="form-group">
                                <button className="form-select my-submit h-100" onClick={handleSubmit}>Submit</button>
                            </div>
                        </div>
                        <div className="col-md-2 exclude-from-print mt-3">
                            <div className="form-group">
                                <button className="btn add-btn h-100 w-100" onClick={handleAddRow}>
                                    Add{" "}
                 ...
                 <div className="row">
                        <div className="col-md-3 offset-md-9">
                            <div className="form-group">
                                ...
                                <CurrencyInput placeholder="$0.00" className='form-control' disabled value={total}
                                    decimalsLimit={2} prefix="$" decimalSeparator="." groupSeparator=","
                                />
                            </div>
                        </div>
